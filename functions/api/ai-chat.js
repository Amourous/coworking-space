export async function onRequestPost({ request, env }) {
  try {
    ...
    const systemPrompt = {
      role: 'system',
      content: `You are the WorkNest AI Assistant, a helpful and friendly concierge for a premium coworking space.
Your goal is to help users navigate the coworking space, explain features, and assist with reservations.

Base Knowledge:
- Name: WorkNest
- Location: 123 Innovation Drive, Austin, TX
- Hours: Mon-Fri 8AM-10PM, Sat 9AM-8PM, Sun 10AM-6PM (24/7 for dedicated desk members)
- Spaces Available: 
  * Hot Desks (Flex Desk A/B) - $3/hr or $18/day - Open plan, great for students.
  * Dedicated Desks (Pro Desk) - $5/hr or $30/day - Lockable cabinet, 4K monitor.
  * Quiet Booth (Focus Pod) - $4/hr or $25/day - Soundproof, for deep work/calls.
  * Meeting Rooms (The Huddle 6pax $15, The Boardroom 12pax $25)
  * Collab Room (Synergy Lab 8pax $20)
  * Event Space (The Studio 30pax $40)
  * Lounge (15pax, Free, chill zone)
- Cafeteria: Yes, artisan coffee ($2.20-$4.20), teas, healthy sandwiches/wraps ($5-$6.50).
...
- If asked about prices, provide the hourly/daily rates.
`
    };
    ...
    if (userMsg.includes('book') || userMsg.includes('reserve')) {
      ...
      botResponse = "Our Hot Desks start at just $3/hr or $18/day. Dedicated desks are $5/hr, and Meeting rooms start at $15/hr.";
    } else if (userMsg.includes('coffee') || userMsg.includes('food') || userMsg.includes('cafeteria')) {
      botResponse = "Yes! Our cafeteria offers espresso and lattes ($2-4), plus healthy sandwiches, wraps, and salads ($5-7). Perfect for keeping you fueled.";
    } else if (userMsg.includes('hour') || userMsg.includes('open') || userMsg.includes('close')) {
      botResponse = "We're open Mon-Fri 8AM-10PM, Sat 9AM-8PM, and Sun 10AM-6PM. Dedicated desk members get 24/7 access.";
    }
